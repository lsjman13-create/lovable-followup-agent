...
| 순위 | 작업 | 노력 | 가치 |
|---|---|---|---|
| 1 | **확정→발송 e2e 자동화** (#6) | 중 | 운영 진입 차단 해제 (✅ 완료) |
| 2 | **에러 시 Notifier 알림 연결** (#8) | 소 | "왜 알림 안 와?" 방지 (✅ 완료) |
| 3 | **청크 분할 처리** (#4) | 중 | 긴 카톡 누락 해결 (✅ 완료) |
| 4 | **README 사용자 가이드** (#13) | 소 | 셀프 운영 시작 가능 (✅ 완료) |
| 5 | **AnthropicAPIClient 실 검증 + 비용 상한** (#9) | 중 | ClaudeCLI fallback 안전망 |
| 6 | **24/7 운영 실험 1주** (#7) | 중 | 장기 안정성 확인 |
| 7 | exaone3.5 + GPU 셋업 (#5) | 중 | 품질·속도 동시 개선 (✅ 완료) |

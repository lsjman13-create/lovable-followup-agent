...
- [ ] 테스트용 톡방 확보 (가급적 "나와의 채팅" 으로 시작)
- [x] `scripts/investigate.py` 작성 *(2026-05-23, 코드만 우선 작성. 본인 PC 실행 대기)*
- [ ] 본인 PC 에서 `uv run python scripts/investigate.py --output docs/investigation-2026-05-23.md` 실행
- [ ] 덤프 결과를 보고 kakao-sender v2 의 패턴과 비교 (RICHEDIT50W, ContactListView_*, ChatRoomListView_* 등)
